...
begin
  ...
  host_dashboard_base := coalesce(current_setting('app.host_dashboard_url', true), 'https://herd.app/dashboard');
  guest_dashboard_base := coalesce(current_setting('app.guest_dashboard_url', true), 'https://herd.app/dashboard/guestview');
