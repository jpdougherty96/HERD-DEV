...
CREATE POLICY "Hosts can view bookings for their classes" ON "public"."bookings" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."classes" c
  WHERE ((c."id" = "class_id") AND (c."host_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view their review tokens" ON "public"."review_tokens" FOR SELECT USING (("user_id" = "auth"."uid"()));
