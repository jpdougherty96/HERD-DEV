...
const SUPABASE_ANON_KEY = Deno.env.get("HERD_SUPABASE_ANON_KEY") ?? Deno.env.get("SUPABASE_ANON_KEY") ?? "";
const SUPABASE_SERVICE_ROLE_KEY = Deno.env.get("HERD_SUPABASE_SERVICE_ROLE_KEY") ??
